tag icon
	...
	def render
		...
		<self>
			switch name
				when "apple"
					<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" class=classes viewBox="0 0 100 100">
						<g fill-rule="nonzero">
				...
				when "book"
					<svg xmlns="http://www.w3.org/2000/svg" class=classes viewBox="0 0 20 20">
